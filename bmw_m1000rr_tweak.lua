Bmw_m1000rrMod = { 
    description = "Bmw_m1000rr tweak"
}

local VehicleBaseFunctions = require("modules/functions/main_functions")

function Bmw_m1000rrMod.new(FinalDriveMultToSet, MaxTorqueMult, BrakingTorqueMult, BrakingFrictionFactorMult, MaxWheelTurnMult, TurnMaxAddMult, TurnMaxSubMult)
	
    --registerForEvent("onInit", function() 
	
	MinRPM=900
	MaxRPM=6450
	MaxTorque=270*MaxTorqueMult
	...
	gearsMaxSpeed[6] = 80*FinalDriveMultToSet
	gearsMinRPM[6] = 2800
	gearsMaxRPM[6] = 6450
	...
	VehicleBaseFunctions.setVehicleSettings("Vehicle.bmw_m1000rr", VehicleEngineData, VehicleDriveModelData, VehicleDataPackage, VehicleWheelDimensionsSetup, true)
	...
	--VehicleBaseFunctions.setVehicleSettings("Vehicle.v_sportbike2_arch_player_02", VehicleEngineData, VehicleDriveModelData, VehicleDataPackage, VehicleWheelDimensionsSetup, true)
	--VehicleBaseFunctions.setVehicleSettings("Vehicle.v_sportbike2_arch_player_03", VehicleEngineData, VehicleDriveModelData, VehicleDataPackage, VehicleWheelDimensionsSetup, true)
	--VehicleBaseFunctions.setVehicleSettings("Vehicle.v_sportbike2_arch_linas_player", VehicleEngineData, VehicleDriveModelData, VehicleDataPackage, VehicleWheelDimensionsSetup, true)
	
	if (VehicleBaseFunctions.version ~= nil and VehicleBaseFunctions.version >= 2.00) then 
		VehicleBaseFunctions.setVehicleSettings("Vehicle.v_sportbike2_arch_courier", VehicleEngineData, VehicleDriveModelData, nil, VehicleWheelDimensionsSetup, true)
		VehicleBaseFunctions.setVehicleSettings("Vehicle.v_sportbike2_arch_tyger_courier", VehicleEngineData, VehicleDriveModelData, nil, VehicleWheelDimensionsSetup, true)
	end
